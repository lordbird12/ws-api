...
class MainProductController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'image', 'text_title', 'text_desc', 'type', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'image', 'text_title', 'text_desc', 'type', 'create_by');

        $D = MainProduct::select($col);
        ...
        if ($d->isNotEmpty()) {
            ...
            for ($i = 0; $i < count($d); $i++) {
                ...
                $d[$i]->type_detail = CategoryProduct::where('id',$d[$i]->type)->first();
            }
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->image && $request->image != null && $request->image != 'null') {
                $Item->image = $this->uploadImage($request->image, '/images/main/');
            }
    ...
    public function updateData(Request $request)
    {
        ...
        try {
            $Item = MainProduct::find($request->id);
